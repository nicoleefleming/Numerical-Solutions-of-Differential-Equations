...
public class LinearSolvers extends Substitution
{
    ...
    public double[] DirichletSolve(double[][] array, double[] u, double ua, double ub)
    {
        try {
            ...
            File file = new File("C:\\Users\\Nicole\\IdeaProjects\\homework2\\math5620hw2\\Vvalues");
            if (!file.exists()) {
                file.createNewFile();
            }
            ...
            //TODO: Linear Solve for Lower*y = RHS
            solFor = forward(array, fx);

            //TODO: Linear Solve for Upper*u = y
            sol = backward(array, solFor);

            //TODO: Print out the values to a file of U and f(x)
            for (int i = 0; i < len; i++) {
